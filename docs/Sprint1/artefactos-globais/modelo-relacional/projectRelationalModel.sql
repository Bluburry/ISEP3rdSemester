...
CREATE TABLE FatorProducao (
  ...
  StocknomeEdificio2    varchar2(50) NOT NULL, 
...
CREATE TABLE Sector_CulturaInstalada (
  SectorsectorID                  nvarchar2(2) NOT NULL, 
  CulturaInstaladanomeParcela     varchar2(50) NOT NULL, 
  CulturaInstaladavariedadePlanta varchar2(50) NOT NULL, 
  CulturaInstaladadiaCultivacao   date NOT NULL, 
  PRIMARY KEY (SectorsectorID, 
  CulturaInstaladanomeParcela, 
  CulturaInstaladavariedadePlanta, 
  CulturaInstaladadiaCultivacao));
...
CREATE TABLE Rega (
  horaInicial nvarchar2(50), 
  horaFinal   nvarchar2(50), 
  operacaoID  number(10) NOT NULL, 
  PRIMARY KEY (operacaoID));
CREATE TABLE Rega_Parcela (
  RegaoperacaoID     number(10) NOT NULL, 
  ParcelanomeParcela varchar2(50) NOT NULL, 
  PRIMARY KEY (RegaoperacaoID, 
  ParcelanomeParcela));
...
ALTER TABLE FatorProducao ADD CONSTRAINT FKFatorProdu667879 FOREIGN KEY (stockID, StocknomeEdificio2) REFERENCES Stock (stockID, nomeEdificio);
...
ALTER TABLE Sector_CulturaInstalada ADD CONSTRAINT FKSector_Cul109559 FOREIGN KEY (SectorsectorID) REFERENCES SectorRega (sectorID);
ALTER TABLE Sector_CulturaInstalada ADD CONSTRAINT FKSector_Cul2230 FOREIGN KEY (CulturaInstaladanomeParcela, CulturaInstaladavariedadePlanta, CulturaInstaladadiaCultivacao) REFERENCES CulturaInstalada (nomeParcela, variedadePlanta, diaCultivacao);
...
ALTER TABLE Rega ADD CONSTRAINT FKRega894123 FOREIGN KEY (operacaoID) REFERENCES Operacao (operacaoID);
ALTER TABLE Rega_Parcela ADD CONSTRAINT FKRega_Parce371257 FOREIGN KEY (RegaoperacaoID) REFERENCES Rega (operacaoID);
ALTER TABLE Rega_Parcela ADD CONSTRAINT FKRega_Parce690097 FOREIGN KEY (ParcelanomeParcela) REFERENCES Parcela (nomeParcela);
...
ALTER TABLE SectorRega ADD CONSTRAINT FKSectorRega116930 FOREIGN KEY (nomeEdificio) REFERENCES Edificio (nomeEdificio);
